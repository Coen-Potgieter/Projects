...
arc_entr = Entry(width=15, bg=bg, fg=white, highlightthickness=0)
...
def init_params():
    ...
    weights, bias = get_empty_arr(nodes)
...
def handler(X=None, Y=None, mode=None, init=None, iters=None):
